...
class GraspRGBDCapture():
    ...
    def save(self, pc, modelname, model_pose, camera_pose, r_index, p_index, y_index):
        data_dir = "/srv/data/gazebo_generated/data/asymetric/" + self.date_str + "/" + modelname + "/pointclouds/"
        # data_dir = "data/shape_completion_data2/" + modelname + "/"  # + "/pointclouds/"
...
if __name__ == '__main__':
    ...
    model_path = "/srv/data/processed_mesh_models/asymetric_models/"
